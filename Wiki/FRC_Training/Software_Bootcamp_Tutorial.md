...
> >   ![](./Software_Bootcamp_Tutorial_files/pasted_image_260718.png)
...
![](./Software_Bootcamp_Tutorial_files/pasted_image_260718-001.png)
...
![](./Software_Bootcamp_Tutorial_files/pasted_image_260718-002.png)
...
private void configureBindings() {
    ...
    new Trigger(m_ledSubsystem::getButtonState)
        .onTrue(new turnOn(m_ledSubsystem));
  }
```
...
```java
  private void configureBindings() {
    ...
    m_driverController.b().whileTrue(m_ledSubsystem.turnOn());
  }
```
